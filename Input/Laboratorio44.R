...
# El resultado es que se grafican los renglones y no las columnas por lo que el grafo no nos dice mucho
# Para conocer mas sobre heatmap puede preguntarse
?heatmap
...
# El orden de los autos es conforme al dendrograma y no se modifica el orden de las columnas como puede verse 
# con el siguiente comando. Los coches se ordenaron de acuerdo al clusteo presentado en el dendrograma
